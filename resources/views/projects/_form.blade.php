<div class="space-y-4">
    ...
    <div>
        ...
        <textarea name="description" id="project_description" rows="2"
                  class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500">{{ old('description', $project?->description) }}</textarea>
    </div>
        ...
        <div class="grid grid-cols-3 gap-3">
            <div>
                <input type="number" name="impact_score" min="1" max="10" value="{{ old('impact_score', $project?->impact_score) }}"
                       class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500" placeholder="Impact">
            </div>
            <div>
                <input type="number" name="confidence_score" min="1" max="10" value="{{ old('confidence_score', $project?->confidence_score) }}"
                       class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500" placeholder="Confidence">
            </div>
            <div>
                <input type="number" name="ease_score" min="1" max="10" value="{{ old('ease_score', $project?->ease_score) }}"
                       class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500" placeholder="Ease">
            </div>
        </div>
    </div>
