                ...
                <form method="POST" action="{{ route('reviews.submit-daily') }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="completed_today" rows="2" class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500"
                        ...
                        <div>
                            ...
                            <textarea name="mattered_most" rows="2" class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500"
                        ...
                        <div>
                            ...
                            <textarea name="focus_tomorrow" rows="2" class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500"
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2" class="w-full rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500"
